      ...
      <div className="p-5 flex flex-col gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <span className="text-xs text-muted-foreground">Incentive novas ferramentas</span>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-1.5 mt-1">
          <span className="text-xs font-bold text-muted-foreground/60 uppercase tracking-widest pl-1">
          ...
          <div className="flex gap-2">
            <div className="flex-1 min-w-0 bg-muted/30 dark:bg-card/40 border border-border/40 px-3 py-2.5 rounded-xl flex items-center">
              <code className="text-sm text-foreground/90 font-mono truncate w-full">
                {PIX_KEY}
              </code>
            </div>
            ...
            <button
              onClick={handleCopy}
              className={`shrink-0 flex items-center justify-center gap-1.5 px-3.5 py-2.5 rounded-xl text-sm font-semibold shadow-sm transition-all duration-300 active:scale-95 ${
                copied 
